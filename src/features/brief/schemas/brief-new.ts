...
export const MODULE_HOURS = {
  ...
  fixed: {
    discovery: 12, // Увеличено: анализ, ТЗ, прототипирование (бесплатно для клиента)
...
export const HOURLY_RATES = {
  discovery: 0, // Планирование и анализ - БЕСПЛАТНО
  ...
  testing: 20, // Тестирование и QA (было 40)
  deployment: 22.5, // Деплой и настройка (было 45)
  documentation: 17.5, // Документация (было 35)
} as const;
